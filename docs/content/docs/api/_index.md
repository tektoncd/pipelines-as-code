...
This section provides reference documentation for Pipelines-as-Code custom resources and configuration options. Use these pages to look up field definitions, default values, and configuration syntax.
